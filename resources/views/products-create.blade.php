                ...
                <div class="card-body">
                    <form method="post" action="{{ route('product_store') }}">
                      ...
                      <div class="form-group mb-3">
                            ...
                            <img alt="" id="preview_image" src="" class="d-none mt-3" width="150">
                      </div>
                      <div class="form-group mb-3">
                        <table class="table table-bordered">
                            <tr>
                                <td width="30%">Size</td>
                                <td>
                                    <select name="size[]" class="form-control" multiple="multiple"></select>
                                </td>
                            </tr>
                            <tr>
                                <td width="30%">Color</td>
                                <td><select name="color[]" class="form-control" multiple="multiple"></select></td>
                            </tr>
                        </table>
                      </div>
